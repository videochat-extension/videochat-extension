...
export function createSettingsHotkeys() {
    return utils.createElement('div', {}, [
        ControlsTabSettings.createSettingsHeader(chrome.i18n.getMessage("settingsHotkeys")),

        ControlsTabSettings.createSettingsCheckbox("b", "hotkeys", chrome.i18n.getMessage("enablehotkeys"), chrome.i18n.getMessage("tooltipEnableHotkeys"),
            () => {
